...
def paymentwin():
    ...
    bg = customtkinter.CTkImage(dark_image=Image.open("pexels-rovenimagescom-949587.jpg"), size=(1920, 1080))
    ...
    pay_frame = customtkinter.CTkFrame(master=app, width=900, height=870, fg_color="transparent",
                                          border_width=10,
...
def mapwin():
    ...
    detail_frame = customtkinter.CTkFrame(master=app, width=1000, height=1100, fg_color="#272f32", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    detail_frame.pack(padx=50, pady=50, side = tk.LEFT)
    detail_frame.pack_propagate(False) #to make sure it doesn't get resized

    data_frame = customtkinter.CTkFrame(master=app, width=1080, height=1200, fg_color="#272f32", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
    ...
    def add_function():
        if departuredate.get() == "":
            ...
            mycon = sqlcon.connect(host="localhost", user="root", password="root", database="flight")
    ...
    map_widget = tkintermapview.TkinterMapView(data_frame, width=700, height=550, corner_radius= 20)
    ...
    paybutton = customtkinter.CTkButton(master=data_frame, text="Pay", text_color="white", width=200, height=50,
                                          border_width=0, corner_radius=8,
...
def bookinghistorywin():
    ...
    main_frame = customtkinter.CTkFrame(master=app, width=900, height=1200, fg_color="transparent", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
...
def serviceswin():
    ...
    services_frame = customtkinter.CTkFrame(master=app, width=1080, height=570,fg_color="transparent",border_width=10,border_color="black") #,border_width=2,border_color="black"
...
def login():
    import mysql.connector as sqlcon
    mycon = sqlcon.connect(host="localhost", user="root", password="root", database="flight") #change your password
...
def createnew():
    ...
    signin_frame = customtkinter.CTkFrame(master=app, width=1080, height=670, fg_color="transparent", border_width=10,
                                          border_color="black")  # ,border_width=2,border_color="black"
...
signin_frame = customtkinter.CTkFrame(master=app, width=1080, height=470,fg_color="transparent",border_width=10,border_color="black") #,border_width=2,border_color="black"
signin_frame.pack(padx=20,pady=150)
signin_frame.pack_propagate(False)
...
usernameentry = customtkinter.CTkEntry(master=signin_frame, placeholder_text="Username",font=("Comfortaa",25),
                                       width=750,height=40,border_width=2,corner_radius=10,textvariable=username)
...
passwordentry = customtkinter.CTkEntry(master=signin_frame, show="*",font=("Comfortaa",25),
                                       width=750,height=40,border_width=2,corner_radius=10)
